...
public static partial class ParserExtensions
{
    ...
    /// </summary>
    public static bool ParseInto<TInput, TOutput>(
        this Parser<TInput, IReadOnlyList<TOutput>> parser,
        ...
        out ReadOnlySpan<TInput> remainingInput)
    {
        ...
        {
            return multiParser.ParseInto(input, outputList, out remainingInput);
        }
        else if (parser.Parse(input, out var output, out remainingInput))
        {
    ...
    public static bool ParseInto<TInput, TOutput>(
        ...
        out ReadOnlySpan<TInput> remainingInput)
    {
        if (parser.Parse(input, out var output, out remainingInput))
        {
