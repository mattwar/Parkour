...
public interface IDocumentCodeActionService : IDocumentService
{
    /// <summary>
    ...
    /// </summary>
    CodeActionResult GetActions(int position, Settings options, CancellationToken cancellationToken);

    /// <summary>
    /// Get the list of operations to be applied in the text editor to perform the code action.
    /// </summary>
    CodeOperationResult GetOperations(ICodeAction action, Settings options, CancellationToken cancellationToken);
}
