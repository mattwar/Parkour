...
public static class TinyTokenTexts
{
...
public static class TinyNodeKinds
{
    public const string LiteralNumber = nameof(LiteralNumber);
    public const string LiteralString = nameof(LiteralString);
